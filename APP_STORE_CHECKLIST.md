...
- Sign-in/account review: Not applicable; the app has no account system.
- Network usage: None in v1.
- Build requirement: Use Xcode 26 or newer with the iOS 26 SDK for submission.
- Release steps: Follow `AppStore/RELEASE_STEPS.md`.
